...
public class Driver {
    ...
    public static AndroidDriver getAndroidDriver()  {
        ...
        if (appiumDriver == null) {
            ...
            // caps.setCapability(MobileCapabilityType.UDID,"emulator-5554"); termınalden adb dives yazıp cihazları görebiliriz ve
            // o şekilde yukadaki 4 satırı yazmadan da telefona bağlanabiliriz.
